"""
Django settings for ejemplo_basico_completo project.
...
SECRET_KEY = '$&&y0-s#qao5%+diefw-ku*a%xpzj90%r9rjg1)8=*_fjh3vwc'
...
ROOT_URLCONF = 'ejemplo_basico_completo.urls'
...
WSGI_APPLICATION = 'ejemplo_basico_completo.wsgi.application'
