...
class ComboUpdateView(View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        try:
            ...
            # Nombre de la base de datos en donde buscar la información, si no
            # se obtiene el valor por defecto es default
            ...
            if app and mod and field and n_value and n_text and bd:
                ...
                if cod != "" and cod != "0":
                    for o in model.objects.using(bd).filter(**filter).\
                            order_by(n_text):
